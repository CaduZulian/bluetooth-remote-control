...
export default function BluetoothConnections({navigation}: any) {
  ...
  return (
    <Container>
      ...
      <View>
        <Subtitle>Dispositivos conectados anteriormente:</Subtitle>
              ...
              <ListItem>
                <View style={{flexDirection: 'row', alignItems: 'center'}}>
                  ...
                  <View>
                    ...
                    <ListItemUuId>{item.id}</ListItemUuId>
                  </View>
                </View>
                ...
                <Button
                  ...
                  title={
                    connectionId === item.id ? 'Conectando...' : 'Conectar'
                  }
                  onPress={() => {
        ...
        <Subtitle style={{marginTop: 16}}>Novos dispositivos:</Subtitle>
      ...
      <Button
        disabled={
          loadingUnpairedDevices || loadingPairedDevices || bluetoothIsOff
            ? true
            : false
        }
        title="Refazer busca"
